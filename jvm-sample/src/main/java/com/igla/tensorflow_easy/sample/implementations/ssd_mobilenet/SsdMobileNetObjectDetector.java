...
/***
 * Based on ssd_mobilenet_coco model
 * ssd_mobilenet_v1_coco_11_06_2017
 * https://github.com/tensorflow/models/blob/master/research/object_detection/g3doc/tf2_detection_zoo.md
 */
public class SsdMobileNetObjectDetector<T> extends DetectorBase<T, ObjectRecognition, Detection>
    ...
    public SsdMobileNetObjectDetector(Config<T> config) throws IOException {
        super(config);
