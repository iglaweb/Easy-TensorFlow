...
import com.igla.tensorflow_easy.sample.implementations.yolo.models.BoundingBox;
import com.igla.tensorflow_easy.sample.implementations.yolo.models.BoxPosition;
...
/**
 * Taken from https://github.com/szaza/tensorflow-example-java
 *
...
public class YOLOClassifier {
    ...
    private PriorityQueue<Recognition> priorityQueue = new PriorityQueue<>(
            MAX_RECOGNIZED_CLASSES, new RecognitionComparator()
    );
